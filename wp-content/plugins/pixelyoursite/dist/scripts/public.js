                ...
                if(options.gdpr.real_cookie_banner_integration_enabled) {
                    ...
                    if (consentApi) {
                        switch (pixel) {
                            ...
                            case "pinterest":
                                return consentApi.consentSync("http", "_pinterest_sess", "https://babycake.app/wp-content/plugins/pixelyoursite/dist/scripts/.pinterest.com").cookieOptIn;
                            default:
                                return true;
                        }
                    }
            ...
            setupGdprCallbacks: function () {
                ...
                if(options.gdpr.real_cookie_banner_integration_enabled) {
                    ...
                    if (consentApi) {
                        ...
                        consentApi.consent("http", "_pinterest_sess", "https://babycake.app/wp-content/plugins/pixelyoursite/dist/scripts/.pinterest.com")
                ...
                if (window.pysWooProductData.hasOwnProperty(product_id)) {
                    if (window.pysWooProductData[product_id].hasOwnProperty('facebook')) {
                        ...
                        if(product_type === Utils.PRODUCT_GROUPED ) {
                            $form.find("https://babycake.app/wp-content/plugins/pixelyoursite/dist/scripts/.woocommerce-grouped-product-list .qty").each(function(index){
